...
static void set_power_profile(int profile) {
    ...
    sysfs_write_int(CPU_BOOST_PATH "input_boost_freq", profiles[profile].input_boost_freq);
    sysfs_write_int(CPU_BOOST_PATH "input_boost_ms", profiles[profile].input_boost_ms);
